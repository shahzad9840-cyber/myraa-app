...
public class DeviceActionExecutor {
    ...
    public static JSONObject execute(Activity activity, String action, JSONObject params) {
        ...
        try {
            switch (action) {
                case "OPEN_APP": {
                    String pkg = params.optString("target", "");
                ...
                case "CHANGE_MEDIA_VOLUME": {
                    ...
                    // "volume" is a signed number; treat negative as lower, else raise.
                    double volume = params.optDouble("volume", 1);
                    am.adjustStreamVolume(
                        AudioManager.STREAM_MUSIC,
                        volume < 0 ? AudioManager.ADJUST_LOWER : AudioManager.ADJUST_RAISE,
