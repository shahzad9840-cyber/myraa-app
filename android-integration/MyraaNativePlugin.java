...
import com.getcapacitor.annotation.PluginMethod; // ← Yeh import missing tha!
...
public class MyraaNativePlugin extends Plugin {
    ...
    public void sendAudioChunk(PluginCall call) {
        ...
        try {
            // Audio chunk send karne ka logic agar GeminiLiveClient mein method hai
            call.resolve();
        } catch (Exception e) {
            call.reject(e.getMessage());
        }
    ...
    public void sendVideoFrame(PluginCall call) {
        String base64 = call.getString("base64", "");
        try {
            // Video frame send karne ka logic agar GeminiLiveClient mein method hai
            call.resolve();
        } catch (Exception e) {
            call.reject(e.getMessage());
        }
    ...
    public void sendToolResponse(PluginCall call) {
        ...
        try {
            // Tool response send karne ka logic agar GeminiLiveClient mein method hai
            call.resolve();
        } catch (Exception e) {
            call.reject(e.getMessage());
        }
